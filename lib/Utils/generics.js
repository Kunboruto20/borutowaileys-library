...
/**
 * Fix pentru printQRIfNecessaryListener - implementare lipsă
 * Afișează codul QR în terminal dacă este necesar
 */
const printQRIfNecessaryListener = (ev, logger) => {
    ev.on('connection.update', (update) => {
        ...
        if (qr) {
            try {
                // Încearcă să importe qrcode-terminal doar dacă este disponibil
                const qrcode = require('qrcode-terminal');
                console.log('\n📱 Scanează codul QR pentru autentificare:');
                qrcode.generate(qr, { small: true });
                console.log('\n');
            } catch (error) {
                // Dacă qrcode-terminal nu este disponibil, afișează doar mesajul
                logger.info('QR Code received, but qrcode-terminal not available');
                console.log('\n📱 Cod QR primit pentru autentificare');
                console.log('Pentru a afișa codul QR în terminal, instalează: npm install qrcode-terminal\n');
            }
        }
    });
};
